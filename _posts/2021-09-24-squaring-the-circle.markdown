...
![Description of the problem](/assets/img/posts/squaring-the-circle/problem.png)
...
![Starting points](/assets/img/posts/squaring-the-circle/starting_points.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
...
![Constructing the integers](/assets/img/posts/squaring-the-circle/buildingz.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
...
![First 2d point](/assets/img/posts/squaring-the-circle/first2dpoint.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
...
![First step of the parallel](/assets/img/posts/squaring-the-circle/parallelstep1.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}

Now, we trace a circumference of radius $$\overline{PQ_1}$$ centered at $$Q_2$$:

![Second step of the parallel](/assets/img/posts/squaring-the-circle/parallelstep2.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}

They intersect at $$P'$$ with the desired properties!

![Third step of the parallel](/assets/img/posts/squaring-the-circle/parallelstep3.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
...
![Perpendicular](/assets/img/posts/squaring-the-circle/perpendicular.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
...
![Coordinate_lifting](/assets/img/posts/squaring-the-circle/lifting.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
...
![sum_and_difference](/assets/img/posts/squaring-the-circle/sumdiff.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
...
![product](/assets/img/posts/squaring-the-circle/prod.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}

This same construction with a minor modification yields the multiplicative inverse:

![inverse](/assets/img/posts/squaring-the-circle/inverse.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
...
![square_root](/assets/img/posts/squaring-the-circle/sqrt.png) 
{: style="height: auto; max-width: 70%; margin-left: auto; margin-right: auto; display:block;"}
