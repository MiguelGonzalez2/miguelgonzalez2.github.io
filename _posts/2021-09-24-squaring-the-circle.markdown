...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/problem.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/starting_points.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/buildingz.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/first2dpoint.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/parallelstep1.png" class="img-fluid rounded z-depth-1" zoomable=true %}

Now, we trace a circumference of radius $$\overline{PQ_1}$$ centered at $$Q_2$$:

{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/parallelstep2.png" class="img-fluid rounded z-depth-1" zoomable=true %}

They intersect at $$P'$$ with the desired properties!

{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/parallelstep3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/perpendicular.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/lifting.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/sumdiff.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/prod.png" class="img-fluid rounded z-depth-1" zoomable=true %}

This same construction with a minor modification yields the multiplicative inverse:

{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/inverse.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/posts/squaring-the-circle/sqrt.png" class="img-fluid rounded z-depth-1" zoomable=true %}
